...
const data = [
  ...
  },
  {
    title: "Monsterra",
    description:
      "A leading multi-chain NFT Game with free-to-play-and-earn mechanism developed by CrescentShine Studio, offering gamers an unparalleled and immersive gaming experience.",
    tag: "Web3 Game",
    img: monsterra,
  ...
  },
  {
    title: "Yooldo",
    description:
      "Yooldo is a gaming platform renowned for its innovative Anti abuse system, Jury DAO",
    tag: "Web3 Game",
    img: yooldo,
  ...
  },
  {
    ...
    description:
      "Spearheading the Blockchain O2O (Online-to-offline) movement in Vietnam",
    tag: "Web2 Transition",
    img: ahafast,
  ...
  },
  {
    title: "Coin98",
    description:
      "The #1 non-custodial, multi-chain wallet, and DeFi gateway, designed to seamlessly connect users to the crypto world in a safe and secure manner.",
    tag: "Wallet",
    img: c98,
  ...
  },
  {
    title: "Micro3",
    description:
      "A Decentralized SocialFi Mint-To-Earn platform that empowers Web3 projects and individuals through the creator economy, leveraging advanced LayerZero and Chainlink technologies.",
    tag: "SocialFi",
    img: micro3,
          ...
          <div className="lg:flex lg:gap-10 w-full">
            <div className="hidden lg:flex lg:flex-col min-w-[354px]">
              {options.map((e, i) => (
                <div
                  key={i}
                  className={`p-4 cursor-pointer h-16 text-[#64656a] text-xl font-normal font-interTight leading-7 rounded-lg ${
                    selectedTag === e.value ? "bg-[#eff2f4]" : ""
                  }`}
            ...
            <div className="flex flex-col gap-4 flex-1">
              ...
              {visibleItems.length < filteredData.length && (
                <button
                  className="w-fit rounded-full bg-[#3189e2] hover:bg-blue-600 transition-all py-4 px-8 text-white text-lg font-semibold font-interTight leading-normal h-[54px] flex items-center"
                  onClick={loadMore}
                >
                  Load more
                </button>
