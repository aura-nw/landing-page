...
function Ecosystem() {
    return (
        <div className="pt-14 pb-8 xl:py-24 bg-[url('../assets/images/img_bg_gradient_mask.png')] bg-cover bg-no-repeat w-screen flex flex-col gap-6 items-center lg:rounded-3xl lg:w-[96vw]">
