...
function Tutorials() {
    return (
        <div className="w-full lg:bg-[url('../assets/images/img_bg_footer_pc.png')] bg-center bg-no-repeat bg-cover lg:h-[600px] xl:h-[850px] min-[2560px]:h-[990px] flex justify-center">
