    ...
    <div className="w-[318px] sm:w-[420px] h-auto sm:h-[358px] flex-col justify-start items-start gap-4 inline-flex">
      ...
      <div className="flex flex-col gap-2">
        <Link
          href={url}
          target="_blank"
          className="self-stretch text-[#1c1f2a] text-[21px] font-semibold font-nacelle leading-[23.10px]"
        >
          {title}
        </Link>
        <span className="self-stretch text-[#64656a] text-sm font-normal font-interTight leading-tight">
          {tag}
        </span>
      </div>
