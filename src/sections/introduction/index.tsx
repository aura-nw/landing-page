...
function Introduction() {
    return (
        <div className="max-w-[867px] flex flex-col gap-8 px-2">
          <div className="flex flex-col items-center gap-10">
            <div className="w-full border border-solid border-[#FFD569] rounded-lg lg:rounded-full p-4 lg:py-3 lg:pl-5 lG:pr-3 bg-blur-brand-linear-gradient flex items-center justify-between">
              <span className="text-light-yellow max-w-[220px] lg:w-[480px] text-[14px] leading-6">📣  Aura Network token migration is available. Migrate now!</span>
              <Link href="/">
