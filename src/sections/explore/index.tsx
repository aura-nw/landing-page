...
import img_first_explore from '@/assets/images/img_first_explore.png';
...
function Explore() {
    return (
        <div className='flex flex-col gap-10 w-full lg:gap-0'>
            <div className="flex flex-col gap-6 items-center lg:order-first lg:flex-row-reverse lg:justify-between lg:min-h-[492px]">
                <div className='lg:flex-1 lg:flex lg:justify-center'>
                    <Image alt='img_first_explore' src={img_first_explore} />
                </div>
                <span className='text-[28px] font-semibold font-ppmori-semibold leading-9 lg:w-[360px]'>Explore Aura IP Network</span>
            </div>

            {/* Infrastructure */}
            <div className='flex flex-col gap-4 lg:gap-10 lg:min-h-[692px] lg:order-2 lg:flex-row lg:items-start lg:mt-[100px] lg:pt-[320px]'>
                ...
                <div className='flex flex-col gap-5 lg:flex-row lg:flex-1'>
            ...
            {/* Abstraction Layer */}
            <div className='flex flex-col gap-4 lg:gap-10 lg:min-h-[692px] lg:order-3 lg:flex-row lg:items-start lg:pt-[320px]'>
                <div className='flex gap-5 items-center border-b border-[#221F19] py-[14px] lg:min-w-[360px]'>
                    <svg width="32" height="33" viewBox="0 0 32 33" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* IP Source */}
            <div className='flex flex-col gap-4 lg:gap-10 lg:min-h-[1212px] lg:order-6 lg:flex-row lg:items-start lg:pt-[320px]'>
                <div className='flex gap-5 items-center border-b border-[#221F19] py-[15px] lg:min-w-[360px]'>
                    <svg width="32" height="33" viewBox="0 0 32 33" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* IP Consumer */}
            <div className='flex flex-col gap-4 lg:gap-10 lg:order-last lg:min-h-[692px] lg:flex-row lg:items-start lg:pt-[320px]'>
                <div className='flex gap-5 items-center border-b border-[#221F19] py-[14px] lg:min-w-[360px]'>
                    <svg width="32" height="33" viewBox="0 0 32 33" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* Data Visualization */}
            <div className='flex flex-col gap-4 lg:gap-10 lg:order-4 lg:min-h-[692px] lg:flex-row lg:items-start lg:pt-[320px]'>
                <div className='flex gap-5 items-center border-b border-[#221F19] py-[14px] lg:min-w-[360px]'>
                    <svg width="32" height="33" viewBox="0 0 32 33" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* Wallet */}
            <div className='flex flex-col gap-4 lg:order-5 lg:flex-row lg:pt-[320px]'>
                <div className='flex gap-5 items-center border-b border-[#221F19] py-[14px] lg:min-w-[360px] lg:max-h-16'>
                    <svg width="32" height="33" viewBox="0 0 32 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="grid grid-cols-2 gap-4 p-4 lg:grid-cols-3 lg:flex-1">
