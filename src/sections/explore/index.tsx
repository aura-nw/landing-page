    ...
    return (
        <div className='flex flex-col gap-10 w-full'>
            <div className="flex flex-col gap-6 items-center">
                ...
                <span className='text-[28px] font-semibold font-ppmori-semibold leading-9'>Explore Aura IP Network</span>
            </div>

            <div className='flex flex-col gap-4'>
                <div className='flex gap-5 items-center border-b border-[#221F19] py-[15px]'>
                ...
                <div className='flex flex-col gap-5'>
                    <div className='border border-[#221F19] rounded-2xl bg-black-charcoal h-[252px] relative'>
                    ...
                    <div className='bg-dark-charcoal p-6 rounded-lg flex flex-col gap-6 border border-linear'>
            ...
            <div className='flex flex-col gap-4'>
                ...
                <div className='flex flex-col gap-4'>
                    <div className='border border-[#221F19] rounded-2xl bg-black-charcoal h-[220px] p-6 flex flex-col gap-6'>
            ...
            <div className='flex flex-col gap-4'>
                ...
                <div className='flex flex-col gap-5'>
                    <div className='bg-dark-charcoal rounded-lg p-5 border-linear'>
            ...
            <div className='flex flex-col gap-4'>
                ...
                <div className="grid grid-cols-2 gap-4 p-4">
                    <div className="bg-dark-charcoal rounded-lg p-5 flex flex-col gap-3 border border-linear h-[128px]">
